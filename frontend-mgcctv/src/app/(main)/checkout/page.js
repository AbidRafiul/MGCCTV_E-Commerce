...
import { CreditCard, MapPin, Package2, Phone } from "lucide-react";
                ...
                <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
                  <div>
                    ...
                    <p className="mt-2 max-w-2xl text-sm leading-relaxed text-blue-100/85">
                      Pastikan produk, alamat pengiriman, dan total pembayaran sudah sesuai sebelum melakukan pembayaran.
                    </p>
                  </div>
